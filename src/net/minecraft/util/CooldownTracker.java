...
import ru.onelove.events.EventCalculateCooldown;
import ru.onelove.events.EventCooldown;
...
public class CooldownTracker {
    ...
    public float getCooldown(Item itemIn, float partialTicks) {
        ...
        onelove.getInstance().getEventBus().post(cooldown);
        ...
        if (!this.cooldowns.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if ((entry.getValue()).expireTicks <= this.ticks) {
                    ...
                    onelove.getInstance().getEventBus().post(eventCooldown);
                    iterator.remove();
