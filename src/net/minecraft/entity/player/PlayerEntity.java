...
import ru.onelove.events.EventLivingUpdate;
...
import ru.onelove.functions.impl.player.AutoTool;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    public void tick() {
        ...
        onelove.getInstance().getEventBus().post(livingUpdate);
    ...
    public boolean func_234569_d_(BlockState p_234569_1_) {
        AutoTool autoTool = onelove.getInstance().getFunctionRegistry().getAutoTool();
