...
import ru.onelove.events.EventStartRiding;
import ru.onelove.events.MovingEvent;
import ru.onelove.events.PostMoveEvent;
import ru.onelove.functions.api.FunctionRegistry;
import ru.onelove.functions.impl.combat.Hitbox;
import ru.onelove.functions.impl.render.Trails;
import ru.onelove.scripts.lua.classes.EntityClass;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                onelove.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                onelove.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        onelove.getInstance().getEventBus().post(new EventStartRiding(entityIn));
