...
import ru.onelove.events.EventDamageReceive;
import ru.onelove.events.JumpEvent;
import ru.onelove.functions.api.FunctionRegistry;
import ru.onelove.functions.impl.misc.AntiPush;
import ru.onelove.functions.impl.render.SwingAnimation;
...
public abstract class LivingEntity extends Entity {
    ...
    public boolean onLivingFall(float distance, float damageMultiplier) {
        ...
        if (i > 0) {
            ...
            if (this instanceof ClientPlayerEntity) {
                onelove.getInstance().getEventBus()
    ...
    protected void jump() {
        ...
        if (this instanceof ClientPlayerEntity entity) {
            onelove.getInstance().getEventBus().post(jumpEvent);
        }
