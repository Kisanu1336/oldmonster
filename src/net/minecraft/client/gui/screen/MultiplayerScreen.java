...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = onelove.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(onelove.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        onelove.getInstance().getViaMCP().viaScreen.tick();
