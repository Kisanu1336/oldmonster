...
import ru.onelove.events.EventCancelOverlay;
import ru.onelove.functions.api.FunctionRegistry;
import ru.onelove.functions.impl.combat.NoEntityTrace;
import ru.onelove.functions.impl.misc.BetterMinecraft;
import ru.onelove.functions.impl.render.GlassHand;
...
public class GameRenderer implements IResourceManagerReloadListener, AutoCloseable {
    ...
    private void hurtCameraEffect(MatrixStack matrixStackIn, float partialTicks) {
        ...
        onelove.getInstance().getEventBus().post(eventCancelOverlay);
