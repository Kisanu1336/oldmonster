package ru.onelove.ui.mainmenu;
...
import ru.onelove.utils.render.KawaseBlur;
...
public class MainScreen extends Screen implements IMinecraft {
    ...
    private final ResourceLocation backmenu = new ResourceLocation("onelove/images/backmenu.png");
    private final ResourceLocation logo = new ResourceLocation("onelove/images/logo.png");
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
        onelove.getInstance().getAltWidget().updateScroll((int) mouseX, (int) mouseY, (float) delta);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        onelove.getInstance().getAltWidget().render(matrixStack, mouseX, mouseY);
    ...
    public boolean charTyped(char codePoint, int modifiers) {
        onelove.getInstance().getAltWidget().onChar(codePoint);
        return super.charTyped(codePoint, modifiers);
    }

    @Override
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        onelove.getInstance().getAltWidget().onKey(keyCode);
        return false;
    }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        onelove.getInstance().getAltWidget().click(fixed.getX(), fixed.getY(), button);
    ...
    public static final ResourceLocation button = new ResourceLocation("onelove/images/button.png");
