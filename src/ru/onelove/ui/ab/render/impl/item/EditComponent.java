package ru.onelove.ui.ab.render.impl.item;

import com.mojang.blaze3d.matrix.MatrixStack;
import ru.onelove.onelove;
import ru.onelove.ui.ab.model.IItem;
import ru.onelove.ui.ab.model.ItemImpl;
import ru.onelove.ui.ab.render.impl.AddedItemComponent;
import ru.onelove.ui.ab.render.impl.AllItemComponent;
import ru.onelove.ui.ab.render.impl.Component;
import ru.onelove.utils.client.IMinecraft;
import ru.onelove.utils.components.ButtonComponent;
import ru.onelove.utils.components.FieldComponent;
import ru.onelove.utils.components.SliderComponent;
...
public class EditComponent extends Component implements IMinecraft {
    ...
    private final ButtonComponent add = new ButtonComponent(0, 0, 0, 0, "Добавить", () -> {
        if (!price.get().isEmpty()) {
            ...
            onelove.getInstance().getItemStorage().addItem(stack.getItem(), Integer.parseInt(price.get()), Integer.parseInt(count.fieldComponent.get()), Integer.parseInt(damage.fieldComponent.get()), enchantmentWidget.get());
