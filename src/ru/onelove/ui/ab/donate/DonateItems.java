package ru.onelove.ui.ab.donate;
...
public class DonateItems {
    ...
    public static void add() {
...

        {
            ...
            ItemStack oneloveVisionPotionItem = new ItemStack(Items.POTION);
            oneloveVisionPotionItem.setDisplayName(ITextComponent.getTextComponentOrEmpty("Зелье ночного зрения"));
