...
public class BindComponent extends Component {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        Fonts.montserrat.drawText(stack, setting.getName(), getX() + 5, getY() + 6.5f / 2f + 1, ColorUtils.rgb(45, 45, 45), 6.5f, 0.05f);
        ...
        DisplayUtils.drawRoundedRect(x - 2 + 0.5F, y - 2, Fonts.montserrat.getWidth(bind, 5.5f, activated ? 0.1f : 0.05f) + 4, 5.5f + 4, 2, ColorUtils.rgba(18, 18, 18, 255));
        Fonts.montserrat.drawText(stack, bind, x, y, activated ? -1 : ColorUtils.rgb(45, 45, 45), 5.5f, activated ? 0.1f : 0.05f);
