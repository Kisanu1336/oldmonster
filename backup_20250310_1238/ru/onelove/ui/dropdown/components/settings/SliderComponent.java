package ru.onelove.ui.dropdown.components.settings;
...
public class SliderComponent extends Component {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        Fonts.montserrat.drawText(stack, setting.getName(), getX() + 5, getY() + 4.5f / 2f + 1,
                ColorUtils.rgb(34, 34, 34), 5.5f, 0.05f);
        Fonts.montserrat.drawText(stack, String.valueOf(setting.get()), getX() + getWidth() - 5 - Fonts.montserrat.getWidth(String.valueOf(setting.get()), 5.5f), getY() + 4.5f / 2f + 1,
                ColorUtils.rgb(45, 45, 45), 5.5f, 0.05f);

        DisplayUtils.drawRoundedRect(getX() + 5, getY() + 11, getWidth() - 10, 2, 0.6f, ColorUtils.rgb(18, 18, 18));
        anim = MathUtil.fast(anim, (getWidth() - 10) * (setting.get() - setting.min) / (setting.max - setting.min), 20);
        float sliderWidth = anim;
        DisplayUtils.drawRoundedRect(getX() + 5, getY() + 11, sliderWidth, 2, 0.6f, ColorUtils.rgb(34, 34, 34));
        DisplayUtils.drawCircle(getX() + 5 + sliderWidth, getY() + 12, 5, ColorUtils.rgb(34, 34, 34));
        DisplayUtils.drawShadowCircle(getX() + 5 + sliderWidth, getY() + 12, 6, ColorUtils.rgba(34, 34, 34, 64));
        if (drag) {
