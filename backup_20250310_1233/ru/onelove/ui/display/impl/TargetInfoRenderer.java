...
public class TargetInfoRenderer implements ElementRenderer {
    ...
    public void render(EventDisplay eventDisplay) {
        ...
        if (entity != null) {
            ...
            final ResourceLocation logo = new ResourceLocation("onelove/images/hud/hearth.png");
    ...
    private LivingEntity getTarget(LivingEntity nullTarget) {
        LivingEntity auraTarget = onelove.getInstance().getFunctionRegistry().getKillAura().getTarget();
